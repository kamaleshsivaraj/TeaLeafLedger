...
public class Payment {
    ...
    @Column(nullable = false)
    private Boolean advanceRecovery = false;

    private Double recoveryAmount = 0.0;
    ...
    public Boolean getAdvanceRecovery() { return advanceRecovery; }
    public void setAdvanceRecovery(Boolean advanceRecovery) { this.advanceRecovery = advanceRecovery; }
